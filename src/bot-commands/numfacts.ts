...
function sanitizeNumberInput(input: string | undefined): number | null {
...
async function getNumberFact(number: number | null = null): Promise<string | null> {
...
export const numfacts: CommandFn = async function numfacts(client, message, channel, tags, _config) {
