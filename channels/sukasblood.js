...
class KickChatBot {
  ...
  async sendMessage(message) {
    try {
      ...
      // Additional sanitization for type: "user" - Kick applies stricter spam filters
      if (!hasChannelOAuth) {
        sanitized = sanitized
          .replace(/'/g, '')                     // Remove apostrophes - triggers spam filter
